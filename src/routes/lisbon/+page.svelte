<script lang="ts">
	import Hero from '$lib/components/lisbon/Hero.svelte';
	import PromiseCard from '$lib/components/lisbon/PromiseCard.svelte';
	import ChatVignette from '$lib/components/lisbon/ChatVignette.svelte';
	import TrustBar from '$lib/components/lisbon/TrustBar.svelte';
